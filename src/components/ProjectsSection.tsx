...
const projects: Project[] = [
    ...
    },
    {
        id: 15,
        title: 'Flexit Gym',
        description: 'A modern gym management web app offering scheduling, membership handling, and class booking.',
        tech: ['React', 'TypeScript', 'Next.js', 'Tailwind CSS', 'Firebase'],
        category: 'client' as ProjectCategory,
        screenshot: '/images/flexitgym.webp',
        demoUrl: 'https://flexit-gym.vercel.app/',
        year: '2026',
        clientOrder: 1,
    },
    {
        id: 16,
        title: 'Clinic Whitepearl',
        description: 'A clinic appointment and management system with patient records and booking features.',
        tech: ['React', 'TypeScript', 'Next.js', 'Tailwind CSS', 'MongoDB'],
        category: 'client' as ProjectCategory,
        screenshot: '/images/clinic.webp',
        demoUrl: 'https://clinic-lake-eta.vercel.app/',
        year: '2026',
        clientOrder: 2,
    },
    {
